...
import { FileCheck, Clock, CheckCircle2, AlertCircle, Info } from 'lucide-react';
...
export default function AccountsDashboard({ 
  ...
  onVerify: (entryId: string, status: BillingRecord['invoice_status'], remarks?: string) => Promise<void>;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="card-2d p-8 text-center">
        ...
        <h2 className="text-2xl font-black text-slate-900 uppercase tracking-widest mb-2">Accounts Portal</h2>
        <p className="text-sm text-slate-500 font-bold">Verify and book vendor invoices.</p>
      </div>

      <BillStatus entries={entries} onUpdateStatus={onVerify} userRole="accounts" />
